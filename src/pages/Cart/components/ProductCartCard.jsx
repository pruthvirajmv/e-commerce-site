...
<div className="card card-horizontal">
    <div className="card-img">
        <Link to={`/products/${product._id}`}> <img className="card-img" src={product.image} alt="card"></img>
        </Link>
    </div>
    <div className="card-side-txt">
            ...
            <div className="card-price">
                <div>
                <span>₹ {(product.price-(product.price*product.discount/100))*quantity} &nbsp;
                    <s className="text-small text-gray">MRP. ₹{product.price}</s> </span>
                </div>  
                <span className="text-small"> you save ₹ {(product.price*product.discount/100)*quantity}
